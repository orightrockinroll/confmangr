...
<!--
<link href="./css/zoom_reset.css" rel="stylesheet" type="text/css" />
<link href="./css/zoom_main.css" rel="stylesheet" type="text/css" />		
-->

	<script type='text/javascript' 
		src='./js/css-pop.js'></script>
	...
	<script type='text/javascript' src="./js/jquery.colorbox.js"></script>
		...
		<script>
			$(document).ready(function(){
				...
				$(".group1").colorbox({rel:'nofollow'}); //nofollow/group1
	...
	<!--
		<script type="text/javascript">
			document.querySelector( '#divContainer' ).addEventListener( 'click', function( event ) {
 ...
 <form id="frmEditor" name="frmEditor" action="write_xml_pages.php" method="post" onsubmit="getDivCoords();" enctype="multipart/form-data">
	...
	<div id="divContainer" style="position:absolute;width:1220px;height:800px;margin-left: auto;
       ...
       right: 0;">
		...
		<img src="<?php echo $pageLeft; ?>" style="width: 600px;height: 700px;" />

			<div id="nav_left" style="position:relative; float: left;top:-390px;left:-60px;">
				<a href="default.php?nav=<?php echo 'left&emode='. $_SESSION['editTracked'];?>">
				<img id="Image1" src="./images/left.png" align="left" style="border:none;" /></a>
			</div> 
		...
		<div style="float:right;position: relative;width: 600px;"></div>
			<img src="<?php echo $pageRight; ?>" style="width: 600px;height: 700px;" />
				
			<div id="nav_right" style="position:relative; float: right;top:-390px;left:60px;">
				<a href="default.php?nav=<?php echo 'right&emode='. $_SESSION['editTracked']; ?>">
				<img id="Image2" src="./images/right.png" align="right" style="border:none;" /></a>
			</div>
		<?php
			//echo $pageLeft;
			//echo $pageRight;
	   ...
	   <div style="float:right;position: relative;top:-90px;width:1220px;">
		...
		foreach($catConfigXML as $config) {
			$advanceLoadingPages = $config['advanceLoadingPages'];
			 ...
			 for (;$i<=$advLoadingPages;$i++)
			 {
			  $img = './pages/pHi'.$i.'.jpg';
			 ?>
			 <a class="group1" href="<?php echo $img; ?>" >
	...
	?>
	    <div id="<?php echo $divId;?>" class="<?php if($_SESSION['editTracked'] == 1){echo $edit_mode;} else { echo $view_mode;} ?>" title="<?php echo $url; ?>" onclick="javascript:destroyEditCloneDiv(this.id);"
	              style="position:absolute;background-color:#CC3333;border:solid 0px #F8CB7F;<?php echo $coordinates;?>">

			<!--	  
			<div style="position:relative;margin-top:-32px;width:32px;height:32px;border-width:0px;"">	  
			 --> 
			  ...
			  <!--<a href="<?php echo $link; ?>" target="_blank" ><img id="Image1" src="./images/shopping_cart_icon_9.png" align="right" style="margin-top:-22px;margin-right:-18px;width:32px;height:32px;border-width:0px;" /></a>-->
				...
				<div class="inline_img" >
					<!--<a href="#" onclick="showImage(' <?php echo $pageRight; ?> ');"><img id="Image2" src="./images/zoom_in_png_7.png" style="border-width:0px;" /> </a>-->
					<!--<a href="#" onclick="popup('popUpDiv');"><img id="Image2" src="./images/zoom_in_png_7.png" style="border-width:0px;" /> </a>-->

						<a class="group1" href="<?php if($pagesinfo['x'] < 600) { echo $pageLeft; } else { echo $pageRight; } ?>" >
