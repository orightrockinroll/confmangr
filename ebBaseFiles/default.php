...
<html>
    <head>
        ...
        <?php
			...
			//echo "outside condition<br/>";
               if($nav == 'left' && $isEdit == 0){
            //echo "inside nav=left condition<br/>";
                      if (isset($_SESSION['page_no_restore'])){
                  	//echo "inside isset session page_no_restore <br/>";
                  	$pageno = $_SESSION['page_no_restore'];
                  	unset($_SESSION['page_no_restore']);
            
               	}else{
            //echo "inside else part of isset session page_no_restore <br/>";
               		$pageno = $_SESSION['page_no'] - 2;
               	}
            
			//echo "page number:" . $pageno;
               ...
               if($nav == "first" && $editMode == 0){
                   $_SESSION['page_no'] = 1;
					$pageno_ = $_SESSION['page_no']; 
               }
			   
			   if($nav == "last" && $editMode == 0){
			   ...
			   echo "before:::page number: " . $pageno_ . "<br/>";
			   echo "page count: " . $pageCount . "<br/><br/>";
			  ...
			  echo "after::: page number: " . $pageno_ . "<br/>";
    ...
    <body>
        ...
        <form id="frmEditor" name="frmEditor" action="write_xml_pages.php" method="post" onsubmit="getDivCoords();" enctype="multipart/form-data">
            ...
            <input name="pageNo" id="pageNo" type="text" value="<?php echo $pageno_; ?>" style="font-size: 1px;visibility: hidden;" />
            ...
            <div id="divContainer" class="divContainer" >
                <div id="main" class="main">
                    <!--<div class="leftDIV" ondrop="drop(event, 'left', '<?php echo $isDraggable; ?>')" ondragover="allowDrop(event)">&nbsp;</div>-->
                    <!-- navigate left page-->
                    <?php
                        $pageLeft = './pages/pHi'.$pageno_.'.jpg';
                        ?>
                    <div style="float:left;width: 600px;" onclick="getXyLocation(event);">
                        ...
                        <div id="nav_left" style="position:relative; float: left;top:-420px;z-index:2020" ondrop="drop(event, 'left', '<?php echo $isDraggable; ?>')" ondragover="allowDrop(event)">
                            <!-- left:-60px; -->
                            <a href="default.php?nav=<?php echo 'first&emode='. $isEdit;?>">
                            <img id="ImagePrev" src="./images/fastprevious.png" align="left" style="border:none;width:120px;height:120px;" /></a>
                        </div>
                        <div id="nav_left" style="position:relative; float: left;top:-420px;z-index:2020" ondrop="drop(event, 'left', '<?php echo $isDraggable; ?>')" ondragover="allowDrop(event)">
                            <!-- left:-60px; -->
                    ...
                    <div style="float:left;width: 600px;" onclick="getXyLocation(event);" >
                        ...
                        <div id="nav_right" style="position:relative; float: right;top:-420px;z-index:2020" ondrop="drop(event, 'right', '<?php echo $isDraggable; ?>')" ondragover="allowDrop(event)" >
                            <!-- left:60px; -->
                            <a href="default.php?nav=<?php echo 'last&emode='. $isEdit;?>">
                            <img id="Image2" src="./images/fastforward.png" align="right" style="border:none;width:120px;height:120px;" /></a>
                        </div>
                        <div id="nav_right" style="position:relative; float: right;top:-420px;z-index:2020" ondrop="drop(event, 'right', '<?php echo $isDraggable; ?>')" ondragover="allowDrop(event)" >
                            <!-- left:60px; -->
                    ...
                    <?php
                        ...
                        ?> 	   
                    <!--<div class="rightDIV" ondrop="drop(event, 'right', '<?php echo $isDraggable; ?>')" ondragover="allowDrop(event)">&nbsp;</div>-->
                </div>
    ...
    $fileName = "cat-config";         
    $xmlContent = "
    <property pageCount='20' advanceLoadingPages='6' editMode='0' viewOnEditMode='false' draggable='true'/>
    ";
    $xmlBeg = "<?xml version='1.0' encoding='utf-8'?>"; 
